...
main(int argc, char *argv[])
{
	...
	char *filename = NULL;	/* name of savefile to read packet data from */
	 ...
	 * before processing any of the packet capture data.
	 */
	 ...
	 * print_pkt_fields(), will be called to print field data in the packet
	 * capture data.
	 */
